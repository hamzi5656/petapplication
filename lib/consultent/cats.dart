...
class Catconsultent extends StatefulWidget {

  
  Catconsultent({super.key, });

  @override
  State<Catconsultent> createState() => _CatconsultentState();
}

class _CatconsultentState extends State<Catconsultent> {
               ...
               Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                         AssetImage("asset/images/cat.png"),
                    fit:BoxFit.fill )
                    ),
                  ),
                    Positioned(top: 20,
                                             ...
                                             child: Padding(
                                                                 ...
                                                                 child: Row(
                                                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                                   children: [
                                                                    CircleAvatar(
                                             backgroundImage:AssetImage("asset/images/cat.png") ,
